...
@author zangjinxia
@date 2020-12-3
@brief 实现Landsat8卫星影像的海陆掩模，输出陆地文件和海水文件共两个文件
'''
...
if __name__ == '__main__':
    ...
    # print(proj)
    # print(geotrans)
    # out_caijiantif = os.path.join(outpath,'caijian.tif')
    # shppath = r'G:/data/澳门/2019/caijianSEA1.shp'
    # resizedata.resizeData_unmain.resizedata(shppath,inpath,out_caijiantif)
    ...
    ndwi255 = guiyihua(ndwi,width,height)
    # plt.imshow(ndwi255)
    # plt.axis('off')  # 不显示坐标轴
    # plt.show()
    ...
    os.chdir(outpath)
    #对原影像掩膜,得到水体，0.0001为了反演叶绿素使用，1级影像时去掉
